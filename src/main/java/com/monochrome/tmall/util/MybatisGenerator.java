...
public class MybatisGenerator {
    public static void main(String[] args) throws ParseException, IOException, XMLParserException, SQLException, InterruptedException, InvalidConfigurationException {
        String today = "2018-06-03";

        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        Date nowDate = sdf.parse(today);
        Date d = new Date();
        if (d.getTime() > nowDate.getTime() + 1000 * 60 * 60 * 24) {
